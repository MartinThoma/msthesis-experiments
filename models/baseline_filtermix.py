...
def create_model(nb_classes, input_shape, config=None):
    ...
    # 32x32
    x1 = Convolution2D(15, (1, 1), padding='same',
                       kernel_initializer='he_uniform',
                       kernel_regularizer=l2(0.0001))(x)
    x3 = Convolution2D(13, (3, 3), padding='same',
                       kernel_initializer='he_uniform',
                       kernel_regularizer=l2(0.0001))(x)
    x5 = Convolution2D(3, (5, 5), padding='same',
                       kernel_initializer='he_uniform',
                       kernel_regularizer=l2(0.0001))(x)
    x7 = Convolution2D(1, (7, 7), padding='same',
                       kernel_initializer='he_uniform',
                       kernel_regularizer=l2(0.0001))(x)
    x = concatenate([x1, x3, x5, x7])
    x = BatchNormalization()(x)
    x = Activation('elu')(x)
    x1 = Convolution2D(15, (1, 1), padding='same',
                       kernel_initializer='he_uniform',
    ...
    # 16x16
    x = MaxPooling2D(pool_size=(2, 2))(x)
    x1 = Convolution2D(20, (1, 1), padding='same',
                       kernel_initializer='he_uniform',
                       kernel_regularizer=l2(0.0001))(x)
    x3 = Convolution2D(20, (3, 3), padding='same',
                       kernel_initializer='he_uniform',
                       kernel_regularizer=l2(0.0001))(x)
    x5 = Convolution2D(10, (5, 5), padding='same',
                       kernel_initializer='he_uniform',
                       kernel_regularizer=l2(0.0001))(x)
    x7 = Convolution2D(5, (7, 7), padding='same',
                       kernel_initializer='he_uniform',
                       kernel_regularizer=l2(0.0001))(x)
    x = concatenate([x1, x3, x5, x7])
    x = BatchNormalization()(x)
